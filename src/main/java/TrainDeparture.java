...
public class TrainDeparture {
    ...
    public double determineTimeModifier(final LocalTime currentTime){
        if(currentTime.isAfter(LocalTime.of(5,59)) && currentTime.isBefore(LocalTime.of(9,01))){
            return 2;
        }
        if(currentTime.isAfter(LocalTime.of(8,59)) && currentTime.isBefore(LocalTime.of(15,01))){
            return 0.5;
        }
        return 1;
    }
